...
<li>✅ 支持云控多台设备 同时发布、存草稿 支持批量发布商品</li>
<li>✅ 支持根据浏览量和曝光量大小删除帖子</li>
...
<h5 id="紧急功能点" tabindex="-1"><a class="header-anchor" href="#紧急功能点"><span>紧急功能点</span></a></h5>
</blockquote>
<ul>
<li>✅批量导入 提供一个数据格式导入数据库,方便用户快速接入数据功能</li>
</ul>
<blockquote>
<ol>
<li>2025-06-03 （已完成 TODO 需要增加一个设置主图的功能）</li>
</ol>
</blockquote>
<ul>
<li>✨❌监听自动发货功能</li>
...
<blockquote>
<ol>
<li>2025-06-03 （已完成Java 监听导航栏变化 TODO待测试）</li>
</ol>
</blockquote>
<ul>
<li>✅(2025-06-08)批量采集数据 某鱼整店搬运 -(使用wpf + webview2 已实现) 后续新增-淘宝搬运采集</li>
<li>✨✅流程闭环 用户配置商品管理 --&gt; 用户批量上架商品(多台不同设备 ) --&gt; 上架完成或者失败 --&gt; 上架完成后 监听已购买的商品</li>
</ul>
<blockquote>
<p>2025-07-05</p>
</blockquote>
<ul>
<li>完善修复安卓七版本,设备点击动作兼容问题</li>
<li>增加多重尝试动作,增加本地找图缓存,增加远程找图yolo多种识别模型</li>
<li>完善,图片添加水印问题</li>
<li>增加图片上传到七牛云oss,和本地路径,手机端下载url路径判断问题</li>
<li>增加商品图片可以拖动设置主图,和图片样式美化,交互优化</li>
<li>完善雷电和夜神模拟器上使用,其他脚本的适配下方命令问题</li>
<li>新增无需root 执行ADB命令</li>
</ul>
<blockquote>
<p>2025-05-31</p>
</blockquote>
...
<ul>
<li>商品分组功能 (可以根据现有商品 把商品进行分组 批量分组,方便大批量数据 快速查询)</li>
<li>发布某鱼 (已经实现)</li>
<li>发布转转 (未实现)</li>
<li>TODO暂定其他功能</li>
</ul>
<h4 id="帖子管理" tabindex="-1"><a class="header-anchor" href="#帖子管理"><span>帖子管理</span></a></h4>
<ul>
<li>帖子编辑 (例如某鱼的发布帖子增加 账号活跃度)</li>
<li>帖子采集 (一键采集其他平台的帖子)</li>
<li>帖子列表管理 (可以查询 模糊匹配等功能)</li>
<li>帖子分组 (用于管理帖子列表 绑定分组)</li>
<li>帖子水印</li>
<li>发布某鱼</li>
<li>发布红薯</li>
<li>todo暂定功能</li>
</ul>
<h4 id="todo-暂定-某鱼发布管理" tabindex="-1"><a class="header-anchor" href="#todo-暂定-某鱼发布管理"><span>TODO 暂定 某鱼发布管理</span></a></h4>
<h3 id="链接" tabindex="-1"><a class="header-anchor" href="#链接"><span>链接</span></a></h3>
<ul>
<li>PC链接 <a href="https://api-y.cn/#/" target="_blank" rel="noopener noreferrer">鱼鱼助手</a></li>
<li>apk 需要进入 后台获取</li>
</ul>
<h3 id="流程" tabindex="-1"><a class="header-anchor" href="#流程"><span>流程</span></a></h3>
<ol>
<li>下载安装包</li>
<li>打开软件，登录 链接云控设备</li>
<li>网页端配置 要发布的商品</li>
</ol>
<h4 id="商品管理-1" tabindex="-1"><a class="header-anchor" href="#商品管理-1"><span>商品管理</span></a></h4>
<ul>
<li>商品管理支持添加商品、删除商品、修改商品
<img src="@source/other/auto/image-1.png" alt="alt text"></li>
</ul>
<h4 id="商品发布" tabindex="-1"><a class="header-anchor" href="#商品发布"><span>商品发布</span></a></h4>
<ul>
<li>可以多选设备 进行发布
<img src="@source/other/auto/image-4.png" alt="alt text"></li>
</ul>
<h4 id="商品采集" tabindex="-1"><a class="header-anchor" href="#商品采集"><span>商品采集</span></a></h4>
<ul>
<li>商品采集采用的是 golangd 编写的 爬虫 开放的端口
<img src="@source/other/auto/image-3.png" alt="alt text"></li>
</ul>
<h4 id="增加一个体验功能-有效期十分钟" tabindex="-1"><a class="header-anchor" href="#增加一个体验功能-有效期十分钟"><span>增加一个体验功能 有效期十分钟</span></a></h4>
<ul>
<li><img src="@source/other/auto/image.png" alt="alt text"></li>
</ul>
</div></template>
